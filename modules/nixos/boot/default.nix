  ...
  config = mkMerge [
    (mkIf cfg.enable {
      boot = {
        ...
        kernelPackages = mkOverride 910 pkgs.linuxPackages_xanmod_latest;
        zfs.package = mkOverride 910 pkgs.zfs_unstable;
    ...
    (mkIf cfg.cachyosKernel {
      boot.kernelPackages = mkOverride 900 cachyosFinal;
      boot.zfs.package = mkOverride 900 config.boot.kernelPackages.zfs_cachyos;
    })
  ];
}
